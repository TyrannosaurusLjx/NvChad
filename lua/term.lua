...
-- jump to mappings
map("n", "<C-,>", "<CMD>edit ~/.config/nvim/lua/mappings.lua<CR>", {desc = "jump to mappings"})
map("n", "<C-lt>", function ()
...
-- buffer 管理
-- map("n", "<C-w>", "<CMD>lua require('bufdelete').bufdelete(0, true)<CR>", { desc = "Close buffer" })
map("n", "<C-w>", "<CMD>lua require('nvchad.tabufline').close_buffer()<CR>", { desc = "Close buffer" })

map("i", "<C-s>", "<ESC>:w<CR>", { desc = "Save" , noremap = true, silent = true })
map("n", "<C-s>", "<ESC>:w<CR>", { desc = "Save" , noremap = true, silent = true })

--tab 
map("n", "<C-S-w>", "<CMD>tabclose<CR>", { desc = "Close tab" })
map("n", "<C-S-t>", "<CMD>tabnew<CR>", { desc = "New tab" })
...
map("n", "<C-]>", "<CMD>lua require('nvchad.tabufline').next()<CR>", { desc = "Next buffer" })
map("n", "<C-[>", "<CMD>lua require('nvchad.tabufline').prev()<CR>", { desc = "Previous buffer" })
map("n", "<C-}>", "<CMD>tabNext<CR>", { desc = "Next tab" })
map("n", "<C-{>", "<CMD>tabprevious<CR>", { desc = "Previous tab" })
map("n", "<C-;>", "<CMD>lua require('nvchad.tabufline').move_buf(-1)<CR>", { desc = "Move buffer left" })
map("n", "<C-'>", "<CMD>lua require('nvchad.tabufline').move_buf(1)<CR>", { desc = "Move buffer right" })
...
map("n", "<C-e>", "<CMD>Telescope buffers<CR>", { desc = "List buffers" })
map("n", "<C-o>", "<CMD>Telescope find_files<CR>", { desc = "Find files" })
...
-- 匹配
map("i", "<C-n>", "<C-p>", { desc = "Autocomplete previous" })

--向后删除
map({"i", "c"}, "<C-backspace>", "<Right><backspace>", { desc = "Delete character after cursor" })

--下一行
map("i", "<C-enter>", "<ESC>o", { desc = "Insert new line" })
...
map("n", "<C-L>", "<CMD>:vsplit<CR><CMD>Telescope buffers<CR>", { desc = "Vertical split and list buffers" })
map("n", "<C-H>", "<CMD>:vsplit<CR><C-w>h<CMD>Telescope buffers<CR>", { desc = "Vertical split and move left" })
map("n", "<C-J>", "<CMD>:split<CR><CMD>Telescope buffers<CR>", { desc = "Horizontal split and list buffers" })
map("n", "<C-K>", "<CMD>:split<CR><C-w>k<CMD>Telescope buffers<CR>", { desc = "Horizontal split and move up" })
...
map("t", "<C-ESC>", "<C-\\><C-n>", { desc = "go nterm" })
...
-- session 最近打开的项目
-- map("n", "<C-R>", "<CMD>Telescope session-lens<CR>", { desc = "Session lens" })
map("n","<C-R>", "<CMD>Telescope workspaces<CR>", {desc = "Workspaces"})
map("n", "<C-r>", "<cmd>Telescope oldfiles<CR>", { desc = "Find old files" })
...
-- 粘贴系统剪贴板的内容
map({ "c", "i"}, "<C-v>", "<C-r>+", { desc = "Paste from system clipboard" })
map("t", "<C-v>", "<C-\\><C-N>pi", { desc = "Paste from system clipboard" })
