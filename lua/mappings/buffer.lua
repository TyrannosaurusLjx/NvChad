...
Keymaps("n", { "<leader>bp", "<D-[>", "<D-k>" }, "<cmd>bprevious<cr>", { desc = "Prev Buffer" })
Keymaps("n", { "<leader>bn", "<D-]>", "<D-j>" }, "<cmd>bnext<cr>", { desc = "Next Buffer" })
...
Keymaps("n", { "<D-e>", "<leader>be" }, "<CMD> lua Snacks.picker.buffers()<CR>", { desc = "List buffers" })

Keymap("n", "<D-t>", "<CMD>lua Snacks.scratch()<CR>", { desc = "open scratch" })
Keymap("n", "<D-T>", "<CMD>lua Snacks.scratch.select()<CR>", { desc = "open scratch" })
